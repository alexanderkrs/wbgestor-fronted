...
@Component({
  ...
  templateUrl: './saida-armas-list.component.html',
  styleUrls: ['./saida-armas-list-component.scss']
})
export class SaidaArmasListComponent extends AbstractComponent implements OnInit {
  ...
  constructor(
    ...
    private amigoClientService: SaidaArmasClientService
  ) {
    super();
  ...
  private remover(amigo: any): void {
    this.messageService.addConfirmYesNo('Confirmar Saída da arma?', () => {
